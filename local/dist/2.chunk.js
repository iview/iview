...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonGroup = _iview.Button.Group; // <style>
	//
	// </style>
	// <template>
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        changeRadio: function changeRadio(data) {
	            console.log(data);
	        },
	        changeCB: function changeCB() {
	            this.checkbox = ['梁灏', '段模'];
	        },
	        groupChange: function groupChange(data) {
	            //                console.log(data);
	        },
	        singleChange: function singleChange(data) {
	            //                console.log(data);
	        }
	    }
	};
