...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimelineItem = _iview.Timeline.Item; // <style scoped>
	//     body{
	//         padding: 50px;
	//         height: 2000px;
	//     }
	...
	exports.default = {
	    components: {
	        Badge: _iview.Badge,
	        Tag: _iview.Tag,
	        Progress: _iview.Progress,
	        Circle: _iview.Circle,
	        Timeline: _iview.Timeline,
	        TimelineItem: TimelineItem,
	        Icon: _iview.Icon,
	        Affix: _iview.Affix,
	        Button: _iview.Button,
	        BackTop: _iview.BackTop,
	        Spin: _iview.Spin,
	        Steps: _iview.Steps,
	        Step: Step,
	    ...
	    methods: {
	        ...
	        affixChange: function affixChange(status) {
	            console.log(status);
	        },
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n<badge count=\"10\" _v-4555aca9=\"\">\n    <a class=\"example-badge\" _v-4555aca9=\"\"></a>\n</badge>\n\n<tag color=\"green\" closable=\"\" @on-close=\"closed\" _v-4555aca9=\"\">管理员</tag>\n<progress :percent=\"50\" status=\"active\" :stroke-width=\"20\" _v-4555aca9=\"\">\n\n</progress>\n\n<circle :percent=\"p\" _v-4555aca9=\"\">\n    {{p}}%\n</circle>\n<br _v-4555aca9=\"\"><br _v-4555aca9=\"\">\n<timeline pending=\"\" _v-4555aca9=\"\">\n    <timeline-item color=\"red\" _v-4555aca9=\"\">发布3.0版本</timeline-item>\n    <timeline-item color=\"green\" _v-4555aca9=\"\">\n        <icon type=\"time\" slot=\"dot\" _v-4555aca9=\"\"></icon>\n        发布2.0版本\n    </timeline-item>\n    <timeline-item color=\"#ff6600\" _v-4555aca9=\"\">发布1.0版本</timeline-item>\n    <timeline-item _v-4555aca9=\"\">发布里程碑版本</timeline-item>\n</timeline>\n<br _v-4555aca9=\"\"><br _v-4555aca9=\"\">\n<affix :offset-top=\"50\" @on-change=\"affixChange\" _v-4555aca9=\"\">\n    <button _v-4555aca9=\"\">固定的图钉</button>\n</affix>\n<back-top @on-click=\"backtop\" _v-4555aca9=\"\">\n\n</back-top>\n\n<div style=\"width: 200px;height: 100px;border:1px solid #b2b2b2;position:relative\" _v-4555aca9=\"\">\n    <!--<Spin size=\"large\" fix>加载中...</Spin>-->\n    <spin size=\"large\" fix=\"\" v-if=\"spinShow\" _v-4555aca9=\"\">加载中...</spin>\n</div>\n<div @click=\"spinShow = !spinShow\" _v-4555aca9=\"\">消失</div>\n<br _v-4555aca9=\"\"><br _v-4555aca9=\"\">\n\n<button @click=\"nextStep\" _v-4555aca9=\"\">下一步</button>\n<button @click=\"step_status = 'error'\" _v-4555aca9=\"\">步骤3切换为错误</button>\n<button @click=\"step_process = 'error'\" _v-4555aca9=\"\">切换steps状态为error</button>\n<breadcrumb separator=\"<b>=></b>\" _v-4555aca9=\"\">\n    <breadcrumb-item href=\"/index\" _v-4555aca9=\"\">首页</breadcrumb-item>\n    <breadcrumb-item href=\"/my\" _v-4555aca9=\"\">我的</breadcrumb-item>\n    <breadcrumb-item _v-4555aca9=\"\">\n        <icon type=\"photo\" _v-4555aca9=\"\"></icon>照片\n    </breadcrumb-item>\n</breadcrumb>\n<br _v-4555aca9=\"\">\n<steps :current=\"1\" status=\"error\" _v-4555aca9=\"\">\n    <step title=\"已完成\" content=\"这里是该步骤的描述信息\" _v-4555aca9=\"\"></step>\n    <step title=\"进行中\" content=\"这里是该步骤的描述信息\" _v-4555aca9=\"\"></step>\n    <step title=\"待进行\" content=\"这里是该步骤的描述信息\" _v-4555aca9=\"\"></step>\n    <step title=\"待进行\" content=\"这里是该步骤的描述信息\" _v-4555aca9=\"\"></step>\n</steps>\n<button @click=\"testStatus = 'process'\" _v-4555aca9=\"\">change Status</button>\n";
