    ...
    <div>
        ...
        <div class="layout-demo-con">
            ...
            <Layout :style="{minHeight: '80vh'}">
                <Sider v-model="isCollapsed" collapsed-width="0" hide-trigger breakpoint="sm" @on-collapse="changed" collapsible ref="side" width="200">
                ...
                <Layout class-name="test-class">
                    ...
                    <Content :style="{background:'#FFCF9E'}">
                        ...
                        <Table border :columns="columns8" height="240" :data="data7">
                            <!-- <template slot-scope="scope" slot="name">
                                <slot name="name" :row="scope.row" :column="scope.column" :index="scope.index">
                                    {{scope.column.key}}
                                </slot>
                            </template> -->
                            <span slot="address" slot-scope="scope">
                                <div>
                                    {{scope.row.address}}
                                </div>
                            </span>
