<template>
    ...
    <ul :class="wrapClasses" :style="styles" v-else>
        ...
        <li :title="t('i.page.prev5')" v-if="currentPage - 3 > 1" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev"><a><Icon size="10" type="arrowleft"></Icon></a></li>
        ...
        <li :title="t('i.page.next5')" v-if="currentPage + 3 < allPages" :class="[prefixCls + '-item-jump-next']" @click="fastNext"><a><Icon size="10" type="arrowright"></Icon></a></li>
